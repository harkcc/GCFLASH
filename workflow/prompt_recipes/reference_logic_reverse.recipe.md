...
从截图或参考图反推视觉逻辑。用于把“案例方法论 -> TemplateCard -> 结构化 prompt -> 图生图/生成 -> 评分 -> 修复”连成可重复流程。
...
Reference image is analysis input, not a direct generation reference unless cleaned.
