# Before/After 或 VS 对比图

## 使用场景

Before/After 或 VS 对比图。用于把“案例方法论 -> TemplateCard -> 结构化 prompt -> 图生图/生成 -> 评分 -> 修复”连成可重复流程。
...
Product image is hero; comparison side can be symbolic and must not fake competitor brands.
