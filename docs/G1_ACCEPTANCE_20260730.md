...
| §9 离线测试 | ✅ 145 passed | 编译器 115 + 状态机 30 |
...
> **关于本文引用的产物路径**:本分支只含代码与文档。验收产物(对比板、各轮
> 成品图、P0 冒烟图,共 ~42MB)按「公开仓库不放产品图与成品图」的决定**未随
> 分支发布**,保留在本地 worktree
> `/Users/cc/Desktop/photo_show_g1_reference_generation/artifacts/` 下。
> 文中 `artifacts/...` 的路径均指该本地目录。
